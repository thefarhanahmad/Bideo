...
// Minimal Feather-style icon set (stroke-based) so we avoid an extra dependency.
const base = {
  fill: "none",
  stroke: "currentColor",
  strokeWidth: 2,
...
const Svg = ({ children, className = "w-6 h-6", ...rest }) => (
...
export const ShortsIcon = (p) => (
  <Svg {...p}><rect x="7" y="2" width="10" height="20" rx="2" /><path d="M11 7l4 3-4 3z" /></Svg>
);
