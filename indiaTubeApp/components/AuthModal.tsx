...
const AuthModal: React.FC<AuthModalProps> = ({ visible, onClose, onLoginSuccess }) => {
  ...
  const persistAuth = async (backendRes: any) => {
    ...
    onLoginSuccess(userData); onClose();
  };
