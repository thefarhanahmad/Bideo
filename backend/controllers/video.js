...
const {
  queueWalletCredit,
  revertVideoEarningsOnDeletion,
  getRewardRates,
} = require("../services/walletSettlementService");
...
exports.deleteVideo = async (req, res, next) => {
  try {
    ...
    // Revert all settled and pending revenue generated by this video from creator's wallet
    try {
      ...
      console.error(`[deleteVideo] Error reverting video earnings: ${revErr.message}`);
    }
